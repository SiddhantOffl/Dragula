...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${ORANGE} Phone Reload   	 ${RED}[${WHITE}02${RED}]${ORANGE} Job  
		${RED}[${WHITE}02${RED}]${ORANGE} Instagram    	 ${RED}[${WHITE}12${RED}]${ORANGE} Pinterest  
